...
1 - creare un contenitore con un titolo nell'html;
2 - usare il ciclo for e il console.log per stampare i numeri da 1 a 100 in console;
3 - usare l'operatore del resto per cambiare il messaggio di stampa in base alle regole di cui sopra;
4 - 
